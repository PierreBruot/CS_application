...
public interface SearchUserBox{
...
//TODO to feild
    ...
    default void removeUserFromList(View v) {
        ...
        Log.d("SelectedUsersID",getSelectedUsersId().toString());
        //Cast to Integer to not remove int index
        getSelectedUsersId().remove((Integer) e.getId());
        getSelectedUsersView().remove(v);
